...
//			if (part.getName().startsWith("uploadFile")) {
				...
				String fileName = part.getSubmittedFileName(); // 원본 파일 이름 //파일만 가져오기 파일이 아니면 NULL,Empty=(,파일 첨부하지 않았을때,파일명이없을경우)
				...
				part.write(uploadPath+File.separator+newName); //파일 저장
				
				out.println("업로드된 파일"+ fileCount+": "+fileName+" 저장파일명:"+newName+"<br>");
